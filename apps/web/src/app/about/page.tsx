    ...
    <div className="py-12 md:py-16">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Values Grid */}
          <section className="mb-12 md:mb-16">
            <h2 className="text-xl md:text-2xl font-bold mb-6">Our Values</h2>
            <div className="grid sm:grid-cols-2 gap-4 md:gap-6">
              {values.map((value, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="bg-neutral-50 dark:bg-neutral-900 rounded-xl p-5 md:p-6 border border-neutral-200 dark:border-neutral-800"
                  >
