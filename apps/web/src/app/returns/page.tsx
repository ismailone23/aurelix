      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-6 opacity-80">
          <section>
            ...
            <p>
              We want you to be completely satisfied with your Aurelex purchase.
              If you're not happy with your order, we offer a hassle-free 30-day
              return policy.
            </p>
          </section>
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-2">
              <li>Contact our customer support team at returns@aurelex.com</li>
